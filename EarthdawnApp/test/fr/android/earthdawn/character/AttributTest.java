...
public class AttributTest
{
    ...
    public void testGetRank()
    {
        ...
        Assert.assertEquals(2, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 2 - rank 2
        ...
        // Indice 4 - rank 3
        attribut.incrementIndice();
        Assert.assertEquals(3, RankManager.getRank(attribut.getResultingIndice()));

        // Indice 12 - rank 5
        attribut = new Attribut(12, 0);
        Assert.assertEquals(5, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 13 - rank 6
        attribut.incrementIndice();
        Assert.assertEquals(6, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 14 - rank 6
        ...
        // Indice 16 - rank 7
        attribut.incrementIndice();
        Assert.assertEquals(7, RankManager.getRank(attribut.getResultingIndice()));

        // Indice 27 - rank 10
        attribut = new Attribut(27, 0);
        Assert.assertEquals(10, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 28 - rank 11
        attribut.incrementIndice();
        Assert.assertEquals(11, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 29 - rank 11
        attribut.incrementEvol();
        Assert.assertEquals(11, RankManager.getRank(attribut.getResultingIndice()));
        // Indice 30 - rank 11
